...
import { PlantingSpotQrAdapter } from './planting-spot-qr.adapter';
...
describe('PlantingSpotQrAdapter', () => {
  let adapter: PlantingSpotQrAdapter;
  ...
  beforeEach(() => {
    ...
    adapter = new PlantingSpotQrAdapter(
      queryBus,
      commandBus,
  ...
  it('dispatches both queries and returns PlantingSpotQrData with base64 image', async () => {
    queryBus.execute
