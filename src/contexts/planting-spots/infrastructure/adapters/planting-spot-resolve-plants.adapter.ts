import { IPlantingSpotResolvePlantsPort } from '@contexts/planting-spots/application/ports/planting-spot-resolve-plants.port';
...
@Injectable()
export class PlantingSpotResolvePlantsAdapter
  implements IPlantingSpotResolvePlantsPort
{
  ...
  async findByPlantingSpotId(
    ...
    return result.items.map(
      (plant) =>
        new PlantingSpotPlantViewModel({
          id: plant.id,
          name: plant.name,
