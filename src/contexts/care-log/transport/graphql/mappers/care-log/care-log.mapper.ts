...
import { CareLogEntryResponseDto } from '@contexts/care-log/transport/graphql/dtos/responses/care-log-entry.response.dto';

@Injectable()
export class CareLogGraphQLMapper {
  toResponseDto(vm: CareLogEntryViewModel): CareLogEntryResponseDto {
    const dto = new CareLogEntryResponseDto();
    dto.id = vm.id;
