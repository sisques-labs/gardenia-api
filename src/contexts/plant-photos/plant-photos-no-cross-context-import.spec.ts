...
describe('plant-photos bounded context — cross-context imports', () => {
  it('only imports from @contexts/files or @contexts/plants exclusively via infrastructure/adapters', () => {
    ...
    for (const file of files) {
      ...
      const hasForbiddenImport =
        /from\s+['"](@contexts\/files|@contexts\/plants)[/'"]/.test(content);
