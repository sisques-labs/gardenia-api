...
import { SqsTaskQueueAdapter } from '@core/queue/adapters/sqs/sqs-task-queue.adapter';
...
@Module({
  ...
  providers: [
    ...
    RabbitMqTaskQueueStubAdapter,
    {
      ...
      inject: [ConfigService, BullMqTaskQueueAdapter, SqsTaskQueueAdapter, RabbitMqTaskQueueStubAdapter],
      useFactory: (
