# Plant Species — Global Catalog

**Source change:** plant-species-module (archived 2026-05-31)  
**Last updated:** 2026-05-31

Global platform catalog of species names (`plant-species` bounded context). Name-only CRUD via REST and GraphQL. Names are **globally unique** (case-insensitive). No tenant/`spaceId` on catalog rows.
